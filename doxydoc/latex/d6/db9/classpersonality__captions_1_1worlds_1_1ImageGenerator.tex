...
\begin{DoxyCode}
194     \textcolor{keyword}{def }add\_idx\_stack(self):
195         stack = self.images
196         random.seed()
197         random.shuffle(stack)
198         self.idx\_stack = stack + self.idx\_stack
199 
\end{DoxyCode}
...
\begin{DoxyCode}
211     \textcolor{keyword}{def }save\_idx\_stack(self):
212         with open(self.images\_idx\_stack\_path, \textcolor{stringliteral}{'wb'}) \textcolor{keyword}{as} handle:
213             pickle.dump(self.idx\_stack, handle)
214 
215 
\end{DoxyCode}
