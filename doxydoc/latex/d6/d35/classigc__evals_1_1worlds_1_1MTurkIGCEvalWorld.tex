...
\begin{DoxyCode}
267     \textcolor{keyword}{def }save\_data(self):
268         convo\_finished = \textcolor{keyword}{True}
269         \textcolor{keywordflow}{for} ag \textcolor{keywordflow}{in} self.agents:
270             \textcolor{keywordflow}{if} (
271                 ag.hit\_is\_abandoned
272                 \textcolor{keywordflow}{or} ag.hit\_is\_returned
273                 \textcolor{keywordflow}{or} ag.disconnected
274                 \textcolor{keywordflow}{or} ag.hit\_is\_expired
275             ):
276                 convo\_finished = \textcolor{keyword}{False}
277         \textcolor{keywordflow}{if} \textcolor{keywordflow}{not} convo\_finished:
278             ag.example\_generator.push\_example(self.example\_id)
279             print(\textcolor{stringliteral}{"\(\backslash\)n**Push image \{\} back to stack. **\(\backslash\)n"}.\hyperlink{namespaceparlai_1_1chat__service_1_1services_1_1messenger_1_1shared__utils_a32e2e2022b824fbaf80c747160b52a76}{format}(self.example\_id))
280         self.agents[0].example\_generator.save\_idx\_stack()
281         data\_path = self.opt[\textcolor{stringliteral}{'data\_path'}]
282         \textcolor{keywordflow}{if} \textcolor{keywordflow}{not} os.path.exists(data\_path):
283             os.makedirs(data\_path)
284         \textcolor{keywordflow}{if} convo\_finished:
285             filename = os.path.join(
286                 data\_path,
287                 \textcolor{stringliteral}{'\{\}\_\{\}\_\{\}.pkl'}.\hyperlink{namespaceparlai_1_1chat__service_1_1services_1_1messenger_1_1shared__utils_a32e2e2022b824fbaf80c747160b52a76}{format}(
288                     time.strftime(\textcolor{stringliteral}{"%Y%m%d-%H%M%S"}),
289                     np.random.randint(0, 1000),
290                     self.task\_type,
291                 ),
292             )
...
295                 data\_path,
296                 \textcolor{stringliteral}{'\{\}\_\{\}\_\{\}\_incomplete.pkl'}.\hyperlink{namespaceparlai_1_1chat__service_1_1services_1_1messenger_1_1shared__utils_a32e2e2022b824fbaf80c747160b52a76}{format}(
297                     time.strftime(\textcolor{stringliteral}{"%Y%m%d-%H%M%S"}),
298                     np.random.randint(0, 1000),
299                     self.task\_type,
300                 ),
301             )
302         pickle.dump(
303             \{
304                 \textcolor{stringliteral}{'data'}: self.data,
305                 \textcolor{stringliteral}{'worker'}: self.agents[0].worker\_id,
306                 \textcolor{stringliteral}{'hit\_id'}: self.agents[0].hit\_id,
307                 \textcolor{stringliteral}{'assignment\_id'}: self.agents[0].assignment\_id,
308             \},
309             open(filename, \textcolor{stringliteral}{'wb'}),
310         )
311         print(\textcolor{stringliteral}{'\{\}: Data successfully saved at \{\}.'}.\hyperlink{namespaceparlai_1_1chat__service_1_1services_1_1messenger_1_1shared__utils_a32e2e2022b824fbaf80c747160b52a76}{format}(self.world\_tag, filename))
312 
\end{DoxyCode}
