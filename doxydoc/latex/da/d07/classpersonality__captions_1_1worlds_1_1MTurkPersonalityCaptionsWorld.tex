...
418                     time.strftime(\textcolor{stringliteral}{'%Y%m%d-%H%M%S'}),
419                     np.random.randint(0, 1000),
420                     self.task\_type,
421                 ),
422             )
423         \textcolor{keywordflow}{else}:
424             filename = os.path.join(
425                 data\_path,
426                 \textcolor{stringliteral}{'\{\}\_\{\}\_\{\}\_incomplete.pkl'}.\hyperlink{namespaceparlai_1_1chat__service_1_1services_1_1messenger_1_1shared__utils_a32e2e2022b824fbaf80c747160b52a76}{format}(
427                     time.strftime(\textcolor{stringliteral}{'%Y%m%d-%H%M%S'}),
428                     np.random.randint(0, 1000),
429                     self.task\_type,
430                 ),
431             )
432         comments = [d[\textcolor{stringliteral}{'comment'}] \textcolor{keywordflow}{for} d \textcolor{keywordflow}{in} self.data]
433 
434         \textcolor{keywordflow}{if} len(comments) >= 2:
435             c = comments[0]
436             \textcolor{keywordflow}{if} \_exact\_match(c, comments[1:]):
437                 self.exact\_match = \textcolor{keyword}{True}
438 
439         pickle.dump(
440             \{
441                 \textcolor{stringliteral}{'data'}: self.data,
442                 \textcolor{stringliteral}{'worker'}: self.agents[0].worker\_id,
443                 \textcolor{stringliteral}{'hit\_id'}: self.agents[0].hit\_id,
444                 \textcolor{stringliteral}{'assignment\_id'}: self.agents[0].assignment\_id,
445                 \textcolor{stringliteral}{'exact\_match'}: self.exact\_match,
446                 \textcolor{stringliteral}{'task\_eval'}: self.eval,
447             \},
448             open(filename, \textcolor{stringliteral}{'wb'}),
449         )
450         print(\textcolor{stringliteral}{'\{\}: Data successfully saved at \{\}.'}.\hyperlink{namespaceparlai_1_1chat__service_1_1services_1_1messenger_1_1shared__utils_a32e2e2022b824fbaf80c747160b52a76}{format}(self.world\_tag, filename))
451 
\end{DoxyCode}
