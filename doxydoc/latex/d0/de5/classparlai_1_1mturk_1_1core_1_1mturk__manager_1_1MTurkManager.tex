...
Definition at line 1755 of file mturk\+\_\+manager.\+py.
...
Definition at line 1860 of file mturk\+\_\+manager.\+py.
...
\begin{DoxyCode}
1940     ):
1941         \textcolor{stringliteral}{"""}
1942 \textcolor{stringliteral}{        Handles paying bonus to a turker, fails for insufficient funds.}
1943 \textcolor{stringliteral}{}
1944 \textcolor{stringliteral}{        Returns True on success and False on failure}
1945 \textcolor{stringliteral}{        """}
1946         total\_cost = mturk\_utils.calculate\_mturk\_cost(
1947             payment\_opt=\{\textcolor{stringliteral}{'type'}: \textcolor{stringliteral}{'bonus'}, \textcolor{stringliteral}{'amount'}: bonus\_amount\}
1948         )
1949         \textcolor{keywordflow}{if} \textcolor{keywordflow}{not} mturk\_utils.check\_mturk\_balance(
1950             balance\_needed=total\_cost, is\_sandbox=self.is\_sandbox
1951         ):
1952             shared\_utils.print\_and\_log(
1953                 logging.WARN,
1954                 \textcolor{stringliteral}{'Cannot pay bonus. Reason: Insufficient '}
1955                 \textcolor{stringliteral}{'funds in your MTurk account.'},
1956                 should\_print=\textcolor{keyword}{True},
1957             )
1958             \textcolor{keywordflow}{return} \textcolor{keyword}{False}
1959 
1960         client = mturk\_utils.get\_mturk\_client(self.is\_sandbox)
1961         \textcolor{comment}{# unique\_request\_token may be useful for handling future network errors}
1962         client.send\_bonus(
1963             WorkerId=worker\_id,
1964             BonusAmount=\hyperlink{namespacegenerate__task__READMEs_a5b88452ffb87b78c8c85ececebafc09f}{str}(bonus\_amount),
1965             AssignmentId=assignment\_id,
1966             Reason=reason,
1967             UniqueRequestToken=unique\_request\_token,
1968         )
1969         \textcolor{keywordflow}{if} self.db\_logger \textcolor{keywordflow}{is} \textcolor{keywordflow}{not} \textcolor{keywordtype}{None}:
1970             self.db\_logger.log\_pay\_extra\_bonus(
1971                 worker\_id, assignment\_id, bonus\_amount, reason
1972             )
1973         shared\_utils.print\_and\_log(
1974             logging.INFO,
1975             \textcolor{stringliteral}{'Paid $\{\} bonus to WorkerId: \{\}'}.\hyperlink{namespaceparlai_1_1chat__service_1_1services_1_1messenger_1_1shared__utils_a32e2e2022b824fbaf80c747160b52a76}{format}(bonus\_amount, worker\_id),
1976         )
1977         \textcolor{keywordflow}{return} \textcolor{keyword}{True}
1978 
\end{DoxyCode}
...
1043             )
1044             check = input(\textcolor{stringliteral}{'Enter here: '})
